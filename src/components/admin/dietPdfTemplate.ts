...
<div class="page">
  ...
  <div style="background:#fff;border:1px solid #e8ecf1;border-radius:12px;padding:20px 22px;margin-bottom:20px;page-break-inside:avoid;">
    ...
    <div style="font-size:12px;color:#8892a4;margin-bottom:12px;">FC Máxima estimada (220 - idade): <b style="color:#1a1a2e;">${220 - lead.idade} bpm</b></div>
