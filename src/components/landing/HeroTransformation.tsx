...
const HeroTransformation = ({ profileImage, transformations }: HeroTransformationProps) => {
  ...
  return (
    <section className="relative isolate flex min-h-[calc(100svh-208px)] items-end overflow-hidden px-4 pb-8 pt-safe sm:min-h-[92svh] sm:px-6">
      ...
      <div className="absolute inset-y-0 right-0 z-0 w-1/2 overflow-hidden" aria-hidden="true">
        <img
          src="/uploads/2-1-nova.png"
          alt=""
      ...
      {profileImage && (
        <>
          <img
            ...
            className="absolute bottom-[35%] left-1/2 z-10 h-[48%] max-h-[420px] w-auto max-w-[60vw] -translate-x-1/2 object-contain object-bottom drop-shadow-[0_20px_28px_rgba(0,0,0,0.7)] sm:h-[36svh]"
            fetchPriority="high"
          />
